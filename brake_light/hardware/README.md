...
Key constraints:
- ESP32-C3 + red LED bar: **one series string of high-power red (620–630 nm) +
  boost constant-current driver (TI LM3410)** — selected in
  [`docs/design/de-04`](../../docs/design/de-04-led-render.md). Favor an ESP32-C3
  **module that carries an onboard WS2812 + LiPo charger** to cut designed-in parts —
  see [`docs/hardware.md §2.1`](../../docs/hardware.md#21-integrated-module-candidates-ws2812--lipo-charger).
